  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full transition-all duration-300 ease-in-out transform hover:scale-105">
        <h1 className="text-3xl font-bold text-center mb-6 text-indigo-700">AlexNet: Fire & Smoke Detector</h1>
          ...
          <div className="relative">
            ...
            >
              <span className="flex items-center space-x-2">
                ...
                <span className="font-medium text-gray-600">Drop files to Attach, or <span className="text-indigo-600 underline">browse</span></span>
              </span>
            </label>
          </div>
          {preview && (
