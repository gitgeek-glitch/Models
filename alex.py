...
CORS(app)  # Update with the React frontend URL if different

# Load the AlexNet model
model = tf.keras.models.load_model("C:\\Users\\sehar\\OneDrive\\Desktop\\models\\AlexNet_FireDetection.h5")  # Update this path

# Define class labels for AlexNet
...
if __name__ == '__main__':
    app.run(host="0.0.0.0", port=5001)  # Flask will be hosted on all IPs of the machine (useful for Docker or external access)